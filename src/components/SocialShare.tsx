    ...
    <>
      ...
      {showShareModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-3xl max-w-lg w-full shadow-2xl my-8 max-h-[90vh] overflow-y-auto">
            {/* Share Card Preview */}
            ...
            <div className="p-6 border-t border-gray-100">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    value={shareUrl || ''}
                    readOnly
                    className="flex-1 px-4 py-3 border-2 border-blue-200 rounded-xl bg-blue-50 text-blue-900 text-sm font-medium focus:outline-none focus:border-blue-400 transition-colors"
                  />
                  <button
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 transition-all duration-300 font-semibold"
                >
                  Close
                </button>
              </div>
